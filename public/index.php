...
<div class="container flex">
    <div class="mx-auto prose prose-h1:text-primary prose-h2:text-secondary prose-h2:text-center prose-a:text-accent hover:text-secondary">
        <div id="slideshow-container" class="flex">
            <button id="left_slide_btn">
